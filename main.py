...
img_airfly = Image.open('images/airfly.png')
img_airfly = ImageTk.PhotoImage(img_airfly)
...
bird = canvas.create_image(x,y, anchor = 'nw', image =img_airfly)
...
window.call('wm', 'iconphoto', window._w, img_airfly) 
window.mainloop()